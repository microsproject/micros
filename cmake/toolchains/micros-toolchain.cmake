...
message(STATUS "MicrOS toolchain configuration")
message(STATUS "  MICROS_ARCH='${MICROS_ARCH}'")

# Route to per-arch toolchain config
if(MICROS_ARCH STREQUAL "arm/cortex_m3")
  include(${CMAKE_CURRENT_LIST_DIR}/arm/cortex_m3.cmake)
